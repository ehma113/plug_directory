...
SECRET_KEY = 'django-insecure-$4r4x#l^8hr=0j=&67g@z1ilr$5uiv$=()r4j)9mnm^$*dzy7u'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'], # Tells Django where your HTML lives
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
                ...
                'django.contrib.messages.context_processors.messages', # Needed for Admin messages
            ],
        },
    },
]
